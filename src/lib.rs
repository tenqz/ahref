...
///         "<a href='https://github.com/tenqz/'>Test Link 2</a>".to_string(),
///         "<a class='test' href='https://github.com/tenqz/'>Test Link 3</a>".to_string(),
///         "<a href=\"/\" class=\"nav-link px-2 text-muted\">Main Page</a>".to_string(),
///         "<a href=\"/blog\" class=\"nav-link px-2 text-muted\">Blog</a>".to_string(),
///         "<a href=\"/vacancies/developer\" class=\"nav-link px-2 text-muted\">Vacancies</a>".to_string(),
///         "<a href=\'/policy\' class='nav-link px-2 text-muted'>Policy</a>".to_string()
///     ];
